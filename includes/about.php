...
By <b>@xtr4nge</b>
<br><br>
This module starts msfconsole inside tmux (terminal name: METASPLOIT). To access the metasploit session started from BlackBlulb exec (from terminal) the following command:
<br><br>
